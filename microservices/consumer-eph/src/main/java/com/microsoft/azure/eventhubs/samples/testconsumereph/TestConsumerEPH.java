...
public class TestConsumerEPH
{
    public static void main(String args[]) throws InterruptedException, ExecutionException
    {
    	...
    	String consumerGroupName = System.getenv("CONSUMER_GROUP");
    	String eventHubName = System.getenv("EVENTHUB_NAME");
    	String storageConnectionString = System.getenv("STORAGE_CONNECTIONSTRING");
    	String storageContainerName = System.getenv("BLOB_CONTAINER");
		String hostNamePrefix = "eph";
		String eventHubConnectionString = System.getenv("EVENTHUB_CONNECTIONSTRING");
